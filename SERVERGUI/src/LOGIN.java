...
public class LOGIN extends javax.swing.JFrame {
    ...
    int sh=(int)(d.getHeight());
     setLocation((sw-getWidth())/2,(sh-getHeight())/2);
  usertext.setOpaque(false);
    ...
    private void initComponents() {
        ...
        usertext = new javax.swing.JPasswordField();
        ...
        usertext.setPreferredSize(new java.awt.Dimension(5, 26));
        jPanel1.add(usertext);
        usertext.setBounds(60, 120, 420, 50);
        ...
        jButton1.setBounds(220, 200, 100, 25);
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
       if(usertext.getText().equals("1221"))
       {
    ...
    private javax.swing.JPasswordField usertext;
